...
- `AuthError.Unwrap()` method for Go 1.13+ error chain compatibility
- `AuthError.Err` field to wrap underlying errors
...
- `Query.Encode()` now produces deterministic output by sorting keys
